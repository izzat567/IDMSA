...
<html lang="en">
  ...
  <body>
    ...
    <header>
      ...
      <div class="header__image">
        ...
        <div class="header__content">
          <div>
            <p class="sub__header">Selamat Datang Ke Halaman Aduan IDMSA</p>
            <h1>Info Dewan Makan<br/>Seri Anggun</h1>
            <p class="section__subtitle">
                Halaman ini disediakan untuk membantu pelajar menyuarakan sebarang aduan atau masalah yang memerlukan perhatian. 
                Sila lengkapkan borang aduan di bawah, dan pihak kami akan berusaha menangani isu anda secepat mungkin.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="form-container">
        ...
        <form action="./backend/aduanpro.php" method="post" enctype="multipart/form-data" >
